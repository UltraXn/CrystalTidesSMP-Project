...
export default function Verify() {
  ...
  const [status, setStatus] = useState(() => token ? "loading" : "error"); // loading, processing, success, error
  const [message, setMessage] = useState(() => token ? "Verificando..." : "Enlace inválido. No se encontró ningún token.");
