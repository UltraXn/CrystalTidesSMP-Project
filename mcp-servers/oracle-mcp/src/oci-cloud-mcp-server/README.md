...
```json
{
  ...
  "data": {
    /* full payload or compact summary */
  },
  "result_meta": {
    "result_mode": "summary",
...
- For "create*\*" and "update*\*" operations, if the parameter is named like "vcn_details" (missing the verb),
...
- \_\_model: Simple class name in the client's models module (e.g., "CreateVcnDetails")
- \_\_model_fqn: Fully-qualified class name (e.g., "oci.core.models.CreateVcnDetails")
