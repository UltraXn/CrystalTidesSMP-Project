...
2. Structured MAP with advanced DBOPTIONS and BATCHSQL
   ...
   "trailName": "LT",
   "domainName": "OracleGoldenGate",
   "connectionName": "TARGET*CONN",
   "source": {
   "schema": "SCHEMA",
   "table": "*",
   "targetTable": "SCHEMA._"
   },
   "advanced": {
   "dbOptions": [
   "FETCHBATCHSIZE 5000",
...
3. Alternative credentials and advanced parallelism
   ...
   CHUNK_SIZE 10000
   MAP ORDERS._ , TARGET ORDERS.\_;

4. DDL handling and source catalog
   Request:
   {
   "replicatName": "REP*DDL",
   "trailName": "DD",
   "domainName": "OracleGoldenGate",
   "connectionName": "ggadmin",
   "source": {
