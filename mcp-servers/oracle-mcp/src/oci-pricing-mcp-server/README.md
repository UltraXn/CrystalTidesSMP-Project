...
[https://docs.oracle.com/en-us/iaas/Content/GSG/Tasks/signingup_topic-Estimating_Costs.htm#accessing_list_pricing](https://docs.oracle.com/en-us/iaas/Content/GSG/Tasks/signingup_topic-Estimating_Costs.htm#accessing_list_pricing)
...
```json
{
  "mcpServers": {
    "oci-pricing": {
      ...
      "args": ["C:\\Users\\user1\\oci-pricing-mcp-server\\oci-pricing-mcp-server.py"]
    }
  }
}
```
