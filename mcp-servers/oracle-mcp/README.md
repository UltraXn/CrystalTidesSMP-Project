...
- _Cloud access_: Some servers require Oracle Cloud Infrastructure (OCI) credentials and configuration ([OCI docs](https://docs.oracle.com/en-us/iaas/Content/API/Concepts/sdkconfig.htm))
...
_(For Node.js/Java/other servers, follow respective instructions in that server’s README)_
...
```json
{
  "mcpServers": {
    "oracle-oci-api-mcp-server": {
      "command": "uv",
      "args": ["run", "oracle.oci-api-mcp-server"],
      "env": {
