        ...
        return (
            <div className="poll-empty-state">
                ...
                <div>
                    ...
                    {onCreate && (
                        <button type="button" onClick={onCreate} className="btn-primary" style={{ padding: '1rem 2.5rem', fontSize: '1rem' }}>
        ...
        <div className="poll-active-card">
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:'1.75rem', marginBottom:'3.5rem' }}>
                    {poll.options && Array.isArray(poll.options) && poll.options.map((opt) => (
                        <div key={opt.id ?? opt.label} className="poll-option-bar">
                            {/* Progress Fill */}
