...
export default function PolicyPage() {
    ...
    const { data: policy, isLoading, isError } = useQuery<Policy | null>({
        queryKey: ['policy', slug],
        queryFn: () => slug ? getPolicy(slug) : Promise.resolve(null),
        enabled: !!slug
    });
        ...
        <Section className="policy-page">
            ...
            <div className="policy-container custom-scrollbar" style={{ position: 'relative', zIndex: 1, maxWidth: '1000px', margin: '0 auto', padding: '1rem' }}>
                ...
                <header style={{ 
                    ...
                    borderRadius: '32px', marginBottom: '2rem', border: '1px solid rgba(255,255,255,0.02)'
                }}>
                    <div style={{ 
                        width: '80px', height: '80px', 
                        background: 'linear-gradient(135deg, rgba(var(--accent-rgb), 0.2), rgba(88, 28, 135, 0.2))', 
                        borderRadius: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center',
                        color: 'var(--accent)', margin: '0 auto 1.5rem', boxShadow: '0 8px 32px rgba(0,0,0,0.2)',
                    ...
                    <h1 style={{ 
                        fontSize: '3.5rem', fontWeight: 300, letterSpacing: '-1px', 
                        marginBottom: '1rem', textShadow: '0 4px 20px rgba(0,0,0,0.5)',
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', justifyContent: 'center' }}>
                        <button 
                            ...
                            style={{
                                ...
                                color: i18n.language === 'es' ? '#000' : '#fff', border: 'none',
                        ...
                        <button 
                            ...
                            style={{
                                ...
                                color: i18n.language === 'en' ? '#000' : '#fff', border: 'none',
                                padding: '0.4rem 0.8rem', borderRadius: '8px', cursor: 'pointer',
                                fontWeight: 'bold', fontSize: '0.8rem', transition: 'all 0.2s',
                    ...
                    <div style={{ 
                        ...
                        background: 'rgba(0,0,0,0.3)', padding: '0.5rem 1rem', borderRadius: '50px',
                        border: '1px solid rgba(255,255,255,0.05)', color: '#aaa', fontSize: '0.9rem'
                    }}>
                ...
                <div className="policy-content" style={{ 
                    position: 'relative', background: 'rgba(10, 10, 15, 0.6)', backdropFilter: 'blur(20px)',
                    padding: '4rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)',
                    boxShadow: '0 20px 50px rgba(0,0,0,0.3)', lineHeight: '1.8', fontSize: '1.15rem', color: '#e0e0e0'
                }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.8rem', background: 'rgba(255,255,255,0.02)', padding: '1.5rem 3rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                         ...
                         <Link 
                            ...
                            style={{ 
                                ...
                                color: '#fff', padding: '0.8rem 1.5rem', borderRadius: '12px', 
