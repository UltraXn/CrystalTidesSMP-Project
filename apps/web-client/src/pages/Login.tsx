                ...
                <div className="account-card animate-pop-up">
                    ...
                    <div className="social-login-group" style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                        <button
                            ...
                            style={{ background: '#5865F2', color: '#FFFFFF', marginTop: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
                            disabled={isSubmitting}
                        >
                        ...
                        <button
                            ...
                            className="btn-submit"
                            style={{ background: '#9146FF', color: '#FFFFFF', marginTop: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}
                            disabled={isSubmitting}
                        >
